//These are three functions that render SVG icons for sorting.
/*All three functions take a single prop className which is used to apply custom styles to the SVG icon.
 These functions use the SVG syntax to create the icons with
 specific path and styling attributes, and they are exported so that they can be imported and used in other components.
*/
